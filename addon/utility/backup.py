...
import pathlib
import platform
from . addon import preference as get_prefs
...
def documents():
    ...
    if platform.system() == 'Windows':
        import ctypes.wintypes #XXX: potential import error outside of windows?
...
def filepath():
    '''Get the default filepath for the KIT OPS preferences backup.'''
    return str(documents() / 'kitops_prefs.json')
